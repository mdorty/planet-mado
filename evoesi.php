...
$query = "SELECT username FROM members WHERE planet='The Moon'";
...
if(isset($_POST['create']))
{
	...
	$createquery = "INSERT INTO members VALUES('','$username','$password','$race','$currentpl','','$totalpl','$planet','$snakewaycount','$gravity','$credits','$email','$description','$dead','$train','$items','$weighted','$meditate','$meditatecount','$people','$jobs','$alignment','$moves','$sensu')";
