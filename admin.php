...
$moves = $_POST['moves'];
	...
	$updatequery = "UPDATE members SET password='$password',race='$race',currentpl='$currentpl',maxpl='$maxpl',totalpl='$totalpl',planet='$planet',credits='$credits',email='$email',train='$train',meditate='$meditate',meditatecount='$meditatecount',people='$people',sensu='$sensu',items='$items',weighted='$weighted',dead='$dead',jobs='$jobs',alignment='$alignment',description='$description',moves='$moves' WHERE username='$username'";
...
if(isset($_POST['create']))
{
	...
	$createquery = "INSERT INTO members VALUES('','$username','$password','$race','$currentpl','','$totalpl','$planet','$credits','$email','$description','$dead','$train','$items','$weighted','$meditate','$meditatecount','$people','$jobs','$alignment','$moves','$sensu')";
